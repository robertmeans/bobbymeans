...
<head>
	...
	<title>Bobby Means | Evergreen, Colorado</title>
	<link rel="icon" type="image/ico" href="_images/favicon.ico">
	<meta name="viewport" content="width=device-width, user-scalable=no, initial-scale=1.0, maximum-scale=1.0, minimum-scale=1.0">
	<meta name="description" content="Bobby, Robert, Bob, Rob... I'm him">
	<meta name="format-detection" content="telephone=no">

    <meta property="og:url" content="http://www.bobbymeans.com" />
    <meta property="og:type" content="website" />
    <meta property="og:title" content="Bobby Means | Evergreen, Colorado" />
    <meta property="og:image" content="http://www.bobbymeans.com/_images/bobby-means.jpg?<?php echo time(); ?>" />
    <meta property="og:image:alt" content="Bobby Means" />
    <meta property="og:description" content="Bobby, Robert, Bob, Rob... I'm him" />
    ...
    <!-- Google Analytics -->
    <script async src="https://www.googletagmanager.com/gtag/js?id=UA-140046709-6"></script>
    <script>
      window.dataLayer = window.dataLayer || [];
      function gtag(){dataLayer.push(arguments);}
      gtag('js', new Date());

      gtag('config', 'UA-140046709-6');
    </script>
...
<div id="wrapper">
    ...
    <?php
        ...
        $fields_string = '';
        $fields = array(
            'secret' => '6LcOaKoUAAAAANLIx9SqDHRIkEsh5-NoXy1vBbZm',
    ...
    <?php
        ...
        $subject = "Message From BobbyMeans.com Website";
...
<div id="contact-wrapper" class="cf">
        <img class="click-box-01 bob-twirl" src="_images/bobby-means.jpg">
        ...
        <div id="box-01" class="foo">
            <form action="" method="post" id="contactForm" onSubmit="return validateEmail(document.forms[0].email.value);">  
                ...
                <ul>
                  ...
                  <li>
                    <div class="g-recaptcha" data-theme="dark" data-callback="recaptchaCallback" data-sitekey="6LcOaKoUAAAAAPkphTVE3mDtNPVMX2LDEPANIKmA"></div>
                  </li>
                  <li>
